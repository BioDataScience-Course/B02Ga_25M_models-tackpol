...
On remarque que chez la sous-espèce *melancholicus*, le bec a une profondeur médiane légèrement plus importante chez les individus d'Amérique du Sud que ceux d'Amérique Centrale. Chez la sous espèces *satrapa*, la profondeur médiane du bec est plus petite chez les individus sud-américains et plus grande chez les centraméricains.
...
L’analyse des variables morphométriques montre que la longueur du tarse et la profondeur du bec, ainsi que leurs interactions avec la sous-espèce, sont significativement liées et permettent d’identifier partiellement les sous-espèces de *Tyrannus melancholicus.*
...
Les résultats obtenus mettent en évidence l’importance des interactions morphométriques et suggèrent que des études complémentaires sur d’autres caractéristiques anatomiques ou des données génétiques pourraient renforcer l’efficacité de l’identification des sous-espèces.
