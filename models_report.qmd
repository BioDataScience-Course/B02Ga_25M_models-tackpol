...
Les données reprennent différentes mesures morphométriques portant sur le bec (notamment la profondeur) , la queue, les ailes (via la longueur du cordon alaire, définie comme la longeur entre l'articulation carpienne et l'extrémité de la la plus longue rémige quand l'aile est pliée) ainsi que le tarse. Des informations qualitatives comme le stade de vie , le sexe et le pays d'origine sont aussi connues.
...
$$ Tous les termes du modèle sont significativement différents de 0 au seuil $\alpha$ de 5% (test machin pour chaque param , ***XXX à compléter**). Cela démontre l'existence d'une interaction entre la longueur du tarse et la profondeur du bec.
