...
Les données reprennent différentes mesures du bec, de la queue, du tarse et de la distance de Kipp (distance entre l'extrémité de la première rémige secondaire (S~1~) et l’extrémité de la plus longue rémige primaire (L~w~) [@kipp1942flugelbau]). Des informations qualitatives comme le stade de vie , le sexe et le pays d'origine sont aussi connus.

Les données sont issues de @macpherson2021. Les analyses réalisées consistent en ***XXX*** et un modèle linéaire. 
