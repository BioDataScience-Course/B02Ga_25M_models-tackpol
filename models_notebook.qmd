...
tyrcontinent <- tyrannus %>%
  ...
  mutate(continent = case_when(
    country %in% c("Argentina","Bolivia","Brazil","Colombia","Ecuador",
                "Paraguay","Peru","Suriname","Uruguay","Venezuela") ~ "Amérique du Sud",
    country %in% c("Bahamas","Belize","Cayman Islands","Costa Rica","Cuba",
                ...
                "Nicaragua","Panama","Puerto Rico","Trinidad and Tobago") ~ "Amérique Centrale",
    country %in% c("Canada","United States","United States of America") ~ "Amérique du Nord"
  ))

chart(tyrcontinent, continent ~ bill_length %fill=% species) +
  geom_boxplot()
